...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tobi is an interactive AI assistant that writes code, debugs, researches deeply, and finds places on an interactive map." },
      { name: "author", content: "Tobi" },
      { property: "og:title", content: "Tobi — your interactive AI" },
      { property: "og:description", content: "Code, research, and explore the world with Tobi." },
