...
export function UserMenu({ name, email, onOpenHistory, onNewChat }: Props) {
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-11 z-40 w-56 rounded-2xl border border-border bg-card shadow-2xl py-1 text-sm">
