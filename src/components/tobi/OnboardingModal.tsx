      ...
      <form onSubmit={submit} className="w-full max-w-md rounded-3xl border border-tobi/40 bg-card p-7 shadow-2xl glow-ring">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-muted-foreground">Two quick things so I can actually know you.</div>
          </div>
        </div>
        <div className="mt-6 space-y-3">
          ...
          <label className="block">
            <span className="text-[11px] uppercase tracking-wider text-muted-foreground">And how old are you?</span>
